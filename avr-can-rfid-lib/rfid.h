...
extern void mfrc522_write(uint8_t reg, uint8_t data);
extern uint8_t mfrc522_read(uint8_t reg);
extern uint8_t	mfrc522_request(uint8_t req_mode, uint8_t * tag_type);
extern uint8_t mfrc522_to_card(uint8_t cmd, uint8_t *send_data, uint8_t send_data_len, uint8_t *back_data, uint32_t *back_data_len);
#if defined (__cplusplus)
}
#endif
#endif
